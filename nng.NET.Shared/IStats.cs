...
namespace nng
{
    ...
    /// </summary>
    public interface INngStat
    {
        nng_stat NativeNngStruct { get; }
        string Name { get; }
        string Desc { get; }
    ...
    /// </summary>
    public interface IStatChild : INngStat, IEnumerable<IStatChild>
    {
        IStatChild Next();
    }
    ...
    /// </summary>
    public interface IStatRoot : INngStat, IDisposable
    {
    }
}
