...
namespace nng
{
    ...
    public static class AsyncContextExt
    {
        ...
        public static NngResult<ISendReceiveAsyncContext<T>> CreateAsyncContext<T>(this IBusSocket socket, IAPIFactory<T> factory) => factory.CreateSendReceiveAsyncContext(socket);
